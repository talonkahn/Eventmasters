...
pricing and checkout via Flutterwave (NGN) or Stripe (international cards).
...
- **Payments:** Flutterwave (primary, NGN) + Stripe (international)
...
4. The buyer lands on `/payment-result`, which polls the order status and shows their
